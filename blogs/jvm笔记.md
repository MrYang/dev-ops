...
第三行GC回收的区域，DefNew(Default New Generation 表示使用Serial 默认的收集器的年轻代，ParNew：Parallel New Generation，PSYoungGen：Parallel Scavenge)，629119K->69888K，本次垃圾收集之前和之后的年轻代或者老年代内存使用情况，（629120K）该区域的总的大小，花费0.0584157秒
